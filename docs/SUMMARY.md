...
* [What Midway is](introduction/what-is-midway.md)
* [Is Midway a fit?](introduction/is-midway-a-fit.md)
* [Guarantees and limits](introduction/guarantees-and-limits.md)

## Quickstart

* [Overview](quickstart/README.md)
* [Register an application](quickstart/register-an-application.md)
* [Join an account](quickstart/join-an-account.md)
* [Curated launch access](quickstart/curated-launch-access.md)
* [Quote and acquire](quickstart/quote-and-acquire.md)
...
* [What to index](guides/what-to-index.md)
* [Application admin](guides/application-admin.md)
* [Testnet](guides/testnet.md)

## Reference

* [Overview](reference/README.md)
* [Deployments](reference/deployments.md)
* [Launch configuration](reference/launch-configuration.md)
* [Contracts](reference/contracts/README.md)
  * [MidwayBuyer](reference/contracts/midway-buyer.md)
